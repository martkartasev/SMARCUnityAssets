...
namespace RosMessageTypes.Mavros
{
    ...
    public class LogEntryMsg : Message
    {
        ...
        public BuiltinInterfaces.TimeMsg time_utc;
        public uint size;
        ...
        public LogEntryMsg()
        {
            ...
            this.num_logs = 0;
            this.last_log_num = 0;
            this.time_utc = new BuiltinInterfaces.TimeMsg();
            this.size = 0;
        }

        public LogEntryMsg(Std.HeaderMsg header, ushort id, ushort num_logs, ushort last_log_num, BuiltinInterfaces.TimeMsg time_utc, uint size)
        {
            this.header = header;
            this.id = id;
        ...
        private LogEntryMsg(MessageDeserializer deserializer)
        {
            ...
            this.time_utc = BuiltinInterfaces.TimeMsg.Deserialize(deserializer);
