...
namespace RosMessageTypes.Mavros
{
    ...
    public class GPSRAWMsg : Message
    {
        ...
        public const byte GPS_FIX_TYPE_RTK_FLOAT = 5; //  RTK float, 3D position
        public const byte GPS_FIX_TYPE_RTK_FIXED = 6; //  RTK Fixed, 3D position
        ...
        public GPSRAWMsg(Std.HeaderMsg header, byte fix_type, int lat, int lon, int alt, ushort eph, ushort epv, ushort vel, ushort cog, byte satellites_visible, int alt_ellipsoid, uint h_acc, uint v_acc, uint vel_acc, int hdg_acc, ushort yaw, byte dgps_numch, uint dgps_age)
        {
            this.header = header;
